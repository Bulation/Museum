...
семь элементов section +2,
только один заголовок h1 +2,
семь заголовков h2 +2,
шесть заголовков h3 +2,
два элемента nav +2,
три списка ul > li > a +2, 
тринадцать кнопок button +2, 
три тега input type=radio +2, 
два тега input type=number +2, 
два тега input type=range +2, 
...
вёрстка формы соответствует макету +5/10 (Не стилизован select) 
...
параллакс +5 
при кликам по кнопке Discover the Louvre и карточкам секции Visiting открываются полноэкранные панорамы Google Street View встроенные в страницы сайта при помощи iframe +5

изменение стиля интерактивных элементов при наведении и клике +10/10
...
Интерактивность, реализуемая через js +16/16 
